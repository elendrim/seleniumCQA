...
public class AssertText {
	...
	public static BiFunction<WebElement, String, String> GET_CSS_VALUE = (WebElement element, String propertyName) -> element
			.getCssValue(propertyName);
	public static BiFunction<WebElement, String, String> GET_DOM_ATTRIBUTE = (WebElement element, String name) -> element
			.getDomAttribute(name);
	public static BiFunction<WebElement, String, String> GET_DOM_PROPERTY = (WebElement element, String name) -> element
			.getDomProperty(name);
	...
	public static BiConsumer<String, String> ASSERT_CONTAINS = (String expected, String actual) -> assertThat(actual,
			containsString(expected));
	public static BiConsumer<String, String> ASSERT_CONTAINS_IGNORE_CASE = (String expected, String actual) -> assertThat(actual,
			containsStringIgnoringCase(expected));

	public static BiConsumer<String, String> ASSERT_NOT_EQUALS = (String expected, String actual) -> assertThat(actual,
			not(is(equalTo(expected))));
	public static BiConsumer<String, String> ASSERT_NOT_EQUALS_IGNORE_CASE = (String expected, String actual) -> assertThat(actual,
